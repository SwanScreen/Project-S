...
<head>
    ...
    <meta name="description" content="Display beautiful live,real-time Instagram slideshows at weddings, parties, conferences, concerts or anywhere there's a screen." />
    <meta charset="UTF-8" />
    ...
    <meta property="og:description" content="Display beautiful live,real-time Instagram slideshows at weddings, parties, conferences, concerts or anywhere there's a screen." />
    ...
    <meta name="twitter:description" content="Display beautiful live,real-time Instagram slideshows at weddings, parties, conferences, concerts or anywhere there's a screen.">
...
<body>
    ...
    <div id="no_tag">
        ...
        <div id="no_tag_text">We're sorry, no such hashtag was found.
            <br/><a href="/">Try
            again</a>
        </div>
    </div>
    <div id="loveme">
        <img src="http://placehold.it/673x134&text=888poker+%2B+Masterminds+Logo">
        ...
        <div id="loveme_text">
            ...
            <div class="power" style="font-size: 0.35em; text-align:center;margin-top: 1em;">powered by
                <img src="img/swanscreen_logo.png" style="height:2em;position: relative;top: 0.35em;">
            </div>
